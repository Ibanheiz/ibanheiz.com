!function(e){"use strict";e.module("app",["app.controllers","app.directives","app.filters","app.services","ngSanitize","ngRoute","ngResource","ngAnimate"]).config(["$routeProvider","$locationProvider",function(e,o){e.when("/site",{templateUrl:"expose/site/home",controller:"SiteController"}).when("/404",{templateUrl:"expose/main/404",controller:"UserController"}).otherwise({redirectTo:"/mean-seed/404"}),o.html5Mode(!0)}])}(angular);
