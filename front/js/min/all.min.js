...
!function(n){"use strict";function i(){return{restrict:"A",link:function(n,i,e){i.on("click",function(){var n=i.parent().parent().find("nav");n.hasClass("show-menu-principal")?n.removeClass("show-menu-principal"):n.addClass("show-menu-principal")})}}}n.module("app.modules.Site.directives",[]).directive("showMenu",i)}(angular);
